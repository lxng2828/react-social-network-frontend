...
const ProfilePostCard = ({ post, onRefresh, onEdit, onDelete }) => {
  ...
  const handleCommentSubmit = async (content) => {
    try {
      console.log(`💬 ProfilePostCard: handleCommentSubmit called with content: "${content}"`);
      console.log(`💬 ProfilePostCard: postId: ${post.id}, currentUser:`, currentUser);

      // Thêm comment và lấy comment data
      const newComment = await addComment(content);
      console.log(`💬 ProfilePostCard: Comment added successfully:`, newComment);
      ...
      if (onRefresh) {
        console.log(`💬 ProfilePostCard: Calling onRefresh to update post data`);
        onRefresh();
      }
    } catch (error) {
      console.error(`💥 ProfilePostCard: Error in handleCommentSubmit:`, error);
  ...
  const handleCommentSuccess = () => {
    console.log(`💬 ProfilePostCard: handleCommentSuccess called (legacy, not needed)`);
